<div class="generic-container">
	<div class="panel panel-default">
		...
		<div class="formcontainer">
			<form ng-submit="userDetailsCtrl.submit()" name="myForm"
				class="form-horizontal">
				<input type="hidden" ng-model="userDetailsCtrl.user.id" />
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-md-2 control-lable" for="file">Name</label>
						<div class="col-md-7">
							<input type="text" ng-model="userDetailsCtrl.user.username"
								name="uname" class="username form-control input-sm"
				...
				<div class="row">
					<div class="form-group col-md-12">
						...
						<div class="col-md-7">
							<input type="text" ng-model="userDetailsCtrl.user.address"
				...
				<div class="row">
					<div class="form-group col-md-12">
						...
						<div class="col-md-7">
							<input type="email" ng-model="userDetailsCtrl.user.email"
				...
				<div class="row">
					<div class="form-actions floatRight">
						<input type="submit"
							value="{{!userDetailsCtrl.user.id ? 'Add' : 'Update'}}"
							class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid">
						<button type="button" ng-click="userDetailsCtrl.reset()"
	...
	<div class="panel panel-default">
		...
		<div class="tablecontainer">
			<table class="table table-hover">
				...
				<tbody>
					<tr ng-repeat="u in userDetailsCtrl.users">
						<td><span ng-bind="u.id"></span></td>
						<td><span ng-bind="u.username"></span></td>
						<td><span ng-bind="u.address"></span></td>
						<td><span ng-bind="u.email"></span></td>
						<td>
							<button type="button" ng-click="userDetailsCtrl.edit(u.id)"
								class="btn btn-success custom-width">Edit</button>
						</td>
						<td>
							<button type="button" ng-click="userDetailsCtrl.remove(u.id)"
